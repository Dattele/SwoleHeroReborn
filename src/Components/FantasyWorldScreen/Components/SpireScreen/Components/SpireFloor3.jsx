...
export default function SpireFloor3() {
  const { addItem, gainGold, restorePartyHP, visited, visitedLocation } =
    useDanny();
    ...
    >
      {showFountain ? (
        <>
          {drinkWater ? (
            <>
              <TextBox textBox={drinkEvents[fountainIndex]} />
              <button
                className='Next-Btn'
            ...
            <>
              <TextBox textBox={batheEvents[fountainIndex]} />
              <button
                className='Next-Btn'
            ...
            <>
              <TextBox
                textBox={{
                  text: "Danny: 'Alright boys.. do we sip the water like Gentlemen or go full baptism mode?'",
                  image: DanielFace,
                }}
              />
              <NPCChoices
        ...
        <>
          {openChest ? (
            ...
            <>
              <TextBox textBox={chestEvents[chestIndex]} />
        ...
        <>
          <TextBox textBox={spireFloor3Events[eventIndex]} />

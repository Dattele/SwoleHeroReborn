...
export default function ToughGuy() {
  ...
  const choices = [
    { text: "Kiss your biceps before leaving - 'you babies never let me down'", nextScene: '/bronzebell/ironhide' },
    { text: "Congratulate him for holding his own and head out", nextScene: '/bronzebell/ironhide' },
  ];
